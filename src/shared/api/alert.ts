...
const injectedRtkApi = api.injectEndpoints({
    endpoints: (build) => ({
        ...
        >({
            query: (queryArg) => ({
                url: `/api/v1/create_notification`,
                method: "POST",
        ...
        >({
            query: (queryArg) => ({
                url: `/api/v1/notification_delete`,
                method: "DELETE",
        ...
        >({
            query: () => ({ url: `/api/v1/notification_list` }),
        }),
...
export type CreateAlertEndpointAlertManagerV1CreatePostApiResponse = /** status 200 Successful Response */ any
export type CreateAlertEndpointAlertManagerV1CreatePostApiArg = {
    alertConfigRequest: AlertConfigRequest
}
export type DeleteAlertEndpointAlertManagerV1DeleteDeleteApiResponse = /** status 200 Successful Response */ any
export type DeleteAlertEndpointAlertManagerV1DeleteDeleteApiArg = {
    deleteAlertRequest: DeleteAlertRequest
}
export type ListAlertConfigsAlertManagerV1ListGetApiResponse = /** status 200 Successful Response */ any
export type ListAlertConfigsAlertManagerV1ListGetApiArg = void
export type NotificationRequestAlertManagerV1NotificationGetApiResponse = /** status 200 Successful Response */ any
...
export type FuncFetchDataForFrontAlertManagerV1FetchDataForFrontGetApiArg = void
