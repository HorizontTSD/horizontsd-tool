...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    requestForecastNeuralNetworksBackendV1ForecastNeuralNetworksPost:
      build.mutation<
    ...
    updateColForTrainLstmRequestBackendV1UpdateColForTrainLstmPost:
      build.mutation<
...
export type GetVectorizationBackendV1NormalizationPostApiResponse =
  /** status 200 Successful Response */ any;
...
export type FuncUserForecastBackendV1UserForecastPostApiResponse =
  /** status 200 Successful Response */ any;
export type FuncUserForecastBackendV1UserForecastPostApiArg = {
  updateColRequest: UpdateColRequest;
};
export type FuncColsToChoseBackendV1ColsToChosePostApiResponse =
  /** status 200 Successful Response */ any;
...
export type FuncGenerateForecastBackendV1GenerateForecastPostApiResponse =
  /** status 200 Successful Response */ any;
