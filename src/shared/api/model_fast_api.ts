...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    funcFetchPossibleDateForMetriBackendV1FetchPossibleDateForMetrixPost:
      build.mutation<
    ...
    >({
      query: (queryArg) => ({
        url: `/backend/v1/metrix_by_period`,
        method: "POST",
...
export type PredictModelFastApiV1PredictPostApiResponse =
  /** status 200 Successful Response */ any;
export type PredictModelFastApiV1PredictPostApiArg = {
  predictRequest: PredictRequest;
};
export type PredictModelFastApiV1PredictXgbPostApiResponse =
  /** status 200 Successful Response */ any;
export type PredictModelFastApiV1PredictXgbPostApiArg = {
  predictRequest: PredictRequest;
};
export type UpdateModelApiModelFastApiV1UpdateModelPostApiResponse =
  /** status 200 Successful Response */ any;
...
export type FuncGetForecastDataBackendV1GetForecastDataPostApiResponse =
  /** status 200 Successful Response */ any;
export type FuncGetForecastDataBackendV1GetForecastDataPostApiArg = {
  forecastData: ForecastData;
};
export type FuncGetMiniChartsDataBackendV1GetMiniChartsDataGetApiResponse =
  /** status 200 Successful Response */ any;
export type FuncGetMiniChartsDataBackendV1GetMiniChartsDataGetApiArg = void;
export type FuncGetSensorIdListBackendV1GetSensorIdListGetApiResponse =
  /** status 200 Successful Response */ any;
...
export type FuncMetrixByPeriodBackendV1MetrixByPeriodPostApiResponse =
  /** status 200 Successful Response */ any;
