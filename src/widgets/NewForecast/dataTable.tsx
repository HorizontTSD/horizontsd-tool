...
export default function BasicSelect({ list, selected, setSelected }) {
...
function Filter({ column, table }: { column: Column<TableData, any>; table: Table<TableData> }) {
...
export const DataTable = ({ data: original, selected_axis, setSelected_axis }) => {
    ...
    if (
        ...
        Object.keys(original[0] || {}).length === 0
    ) {
        return (
    ...
    return (
        ...
        >
            ...
            <Typography variant="h6" marginBottom={2}>
                Select X (time) and Y (forecast value) axis
            </Typography>
            ...
            <Stack>
                ...
                <Stack>
                    ...
                    <Stack direction={"row"} spacing={0.5}>
                        ...
                        <Typography variant="caption">{table.getState().pagination.pageIndex + 1}</Typography>
                        <Typography variant="caption">of </Typography>
                        <Typography variant="caption">{table.getPageCount()}</Typography>
                    </Stack>
                </Stack>
            </Stack>
        </Stack>
