...
export const MenuContent = () => {
  ...
  const mainListItems = [
    { text: t("sidebar.menu.load_forecast"), icon: <QueryStatsIcon />, value: "forecast" },
    { text: t("sidebar.menu.alert_settings"), icon: <EditNotificationsIcon />, value: "alerts" },
    { text: t("sidebar.menu.data_analysis"), icon: <AnalyticsIcon />, value: "analytics" },
    { text: t("sidebar.menu.quick_forecast"), icon: <RocketLaunchIcon />, value: "quick-forecast" },
  ];
